...
from pdfminer.layout import LAParams, LTImage, LTTextBox, LTTextLine, LTChar, LTAnno, LTFigure, LTTable, LTTextBoxHorizontal
...
create_powerpoint_from_pdf(pdf_path, output_ppt)
